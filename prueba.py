        ...
        if eleccion == "1" :
             ...
             if n == 0  :
              ...
              print("""La masion fue exitosa soldaste el filtro a la perfecion la tripulacion esta contenta 
               ...
               print("""La masion fue exitosa soldaste el filtro a pesar de no haber echo la soldadura correctamente y tener que volver
                     a soldarlo .la tripulacion esta contenta 
                    con la desicion que tomaste , Pueden respirar aire fresco.""")
