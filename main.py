...
def main():
    ...
    while jugar_de_nuevo:
        ...
        energia, combustible, oxigeno, estado_tripulacion, opcion = (
            inicio.seleccionar_dificultad()
        )
        ...
        while estado_juego == "jugando":
            ...
            recursos.mostrar_estado_actual(
            ...
            delta_energia, delta_combustible, delta_oxigeno, delta_tripulacion = (
                eventos.seleccionar_y_manejar_evento(dia_actual, DIAS_TOTALES_MISION)
            )
            ...
            estado_juego = recursos.verificar_derrota(
                dia_actual,
                DIAS_TOTALES_MISION,
                opcion,
                energia,
        ...
        final.mostrar_resultado(
            estado_juego, energia, combustible, oxigeno, estado_tripulacion
        )
